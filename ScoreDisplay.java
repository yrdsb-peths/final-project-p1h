...
public class ScoreDisplay extends Actor
{
    ...
    public static final Color scoreColor = Color.BLUE; //MainMenu.titleColor
    public static final Font scoreFont = new Font("Courier New", false, false, GameWorld.WORLD_HEIGHT / 20); //MainMenu.scoreFont
